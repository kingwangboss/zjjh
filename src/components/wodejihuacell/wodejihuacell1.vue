        ...
        <div class="container" v-for="(item,index) in plandata" @click="commit(item.ID)">
            <div class="top">
                <div class="top-left">
                    ...
                    <div style="margin-left:10px;margin-top:15px;color:rgb(145, 7, 95);font-weight: 500;font-size:5vw;">{{item.PlanName}}</div>
                    <div style="margin-left:10px;margin-top:15px;color:#999999;font-size:4vw;margin-left:5px;">{{item.Version}}</div>
