            ...
            <div style="background:#fff;">
              ...
              <div class="cell-bottom">
                  ...
                  <div v-if="cell.DsType === 0">
                    ...
                    <div class="item2" v-if="cell.EndIndex === 2" style="border: 1px solid rgb(248, 198, 65);background: rgb(248, 198, 65);">
                      {{cell.EndIndex ? cell.EndIndex : 1}}定
                    </div>
                    <div class="item2" v-if="cell.EndIndex === 3" style="border: 1px solid rgb(214, 49, 56);background: rgb(214, 49, 56);">
                      {{cell.EndIndex ? cell.EndIndex : 1}}定
                    </div>
                  </div>
